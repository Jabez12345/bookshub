...
<div id="overlay" class="fixed w-full h-full bg-[rgba(0,0,0,0.5)] top-0 left-0 hidden">
   ...
   <div class="p-4">
    ...
    <ul>
     <li class="mb-2">
      <a class="block p-3 bg-blue-600 text-white rounded-lg flex justify-between items-center" href="#">
       <span>
        Chem 201
       </span>
     ...
     <li class="mb-2">
      <a class="block p-3 bg-gray-100 text-gray-800 rounded-lg flex justify-between items-center" href="#">
       <span>
        Gst 122
       </span>
       <i class="fas fa-chevron-right">
    ...
    <div class="container mx-auto mt-8 px-2 py-16 md:px-16 md:py-2">
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div id="hero" class=" md:w-2/5 h-full relative">
                <img src="view-3d-young-school-student.png" alt="student reading" class="w-full h-full z-50">
            </div>
        </div>
    </div>
</div>
