    ...
    <div class="w-full h-100">
      ...
      <form class="mt-6" action="#" method="POST">
        ...
        <div class="mt-4">
          ...
          <input type="password" name="" id="" placeholder="Enter Password" minlength="6" class="w-full px-4 py-4 rounded-3xl bg-white mt-2 border-4 border-gray-300 focus:ring-4 focus:ring-blue-300 focus:outline-none font-lato" required>
        </div>
        ...
        <button type="submit" class="w-full block bg-blue-600 focus:ring-4 focus:ring-blue-300 transition hover:ring-4 text-white font-semibold rounded-3xl
              px-4 py-4 mt-6">Log In</button>
      </form>

      <hr class="my-6 border-gray-300 w-full">

      <button type="button" class="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-3xl px-4 py-4 border border-gray-300">
      ...
      <p class="mt-8 text-center">Need an account? <a href="#" class="text-blue-500 hover:text-blue-700 font-semibold">Create an
              account</a></p>
